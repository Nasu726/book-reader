...
export function AppShell({
  ...
  return (
    <div className="mx-auto flex min-h-dvh w-full max-w-7xl gap-6 px-4 py-6 sm:px-6 lg:px-8">
      <section
        aria-label="Reader"
        className="min-w-0 flex-1 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950"
      >
        {reader}
        <ReaderControls />
      </section>
      ...
      <aside
        ...
        className="hidden w-[360px] shrink-0 rounded-2xl border border-zinc-200 bg-white p-5 shadow-sm dark:border-zinc-800 dark:bg-zinc-950 xl:block"
      >
